...
| テーブル              | カラム                                           | 内容                                                                                         |
| --------------------- | ------------------------------------------------ | -------------------------------------------------------------------------------------------- |
| `entries`             | id, name, headword, meaning, inflection_class_id | エントリ本体（inflection_class_idはinflection_metaへの参照）                                |
...
```
hubullu compile <INPUT> [--output <OUTPUT.sqlite>]
hubullu render <INPUT.hut>
